        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessProofUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdentityProofUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RejectionReason = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_UserId_PaymentGatewayId",
                table: "Payments",
                columns: new[] { "UserId", "PaymentGatewayId" },
                unique: true);
